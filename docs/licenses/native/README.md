...
the text incorporated by LGPLv3; it does not relicense MALACHI OVERDRIVE as GPL software.
...
https://github.com/mxlzmillie/malachi-overdrive/releases/download/v2.0.9/MALACHI-OVERDRIVE-Native-Sources.tar.gz
