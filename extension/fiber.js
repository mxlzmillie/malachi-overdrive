...
(() => {
   ...
   */
  const OUR_APPS = ['MALACHI OVERDRIVE Core', 'MALACHI OVERDRIVE Desktop', 'TobisComputer'];
  ...
  /** "/MALACHI OVERDRIVE Core/link_…/read" -> "read", or null if that is not a name. */
  ...
  function pluginSnapshot() {
    ...
    for (const button of buttons) {
      ...
      for (let up = 0; fiber && up < 24; up++, fiber = fiber.return) {
        ...
        const externalPlugins = props.connector.name === 'MALACHI OVERDRIVE Plugins';
