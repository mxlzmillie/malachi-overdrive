...
private func requireAccessibility() throws {
    ...
    guard AXIsProcessTrusted() else {
        throw fail(
            ...
            "enable Accessibility for MALACHI OVERDRIVE (Device Control on newer macOS), then fully quit and reopen the app"
        )
    }
}
...
private func requireScreenCapture() throws {
    guard CGPreflightScreenCaptureAccess() else {
        ...
        throw fail(
            ...
            "enable Screen Recording for MALACHI OVERDRIVE, then fully quit and reopen the app"
        )
    }
}
