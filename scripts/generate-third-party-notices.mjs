...
const notices = [
  'MALACHI OVERDRIVE — Third-party Notices',
  '',
  'MALACHI OVERDRIVE remains MIT licensed; see LICENSE. This inventory preserves the license and notice texts',
  ...
  '',
  'Catalog artwork: Copyright (c) 2026 MALACHI OVERDRIVE contributors. MIT licensed, see LICENSE.',
  ...
  'are not bundled with MALACHI OVERDRIVE; their package directories retain their own licenses and notices.',
  ''
];
const missing = [];
let count = 0;
...
notices.push('='.repeat(80), 'Optional plugin catalog — separate installations and hosted services', 'Reviewed package licenses and hosted-service references follow. External server code is not bundled with MALACHI OVERDRIVE; custom installations and updates retain their own notices.', '');
