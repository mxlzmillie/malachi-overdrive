...
const app = process.argv[3]
  ...
  : path.join(releaseDir, unpackedDir, 'MALACHI OVERDRIVE.app');
...
const expectedPlist = {
  ...
  NSScreenCaptureUsageDescription:
    'MALACHI OVERDRIVE captures a display or window only when the enabled Desktop connector asks to observe it.'
};
...
const mainExecutable = path.join(contents, 'MacOS', 'MALACHI OVERDRIVE');
