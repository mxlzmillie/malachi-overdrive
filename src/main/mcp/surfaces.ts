 ...
 */
export const CONNECTOR_BRAND = 'MALACHI OVERDRIVE';
 ...
 *
 * Core declares 11 possible tool names below, but at most 10 schemas are live at once.
...
const CORE: SurfaceDefinition = {
  id: 'core',
  serverName: 'malachi-overdrive-core',
  ...
  required: true,
  tools: ['preview', 'read', 'view_image', 'find', 'apply_patch', 'exec_command', 'write_stdin', 'download_artifact', 'session', 'agents', 'session_finish']
};
...
const DESKTOP: SurfaceDefinition = {
  id: 'desktop',
  serverName: 'malachi-overdrive-desktop',
...
const PLUGINS: SurfaceDefinition = {
  id: 'plugins', serverName: 'malachi-overdrive-plugins',
  connectorName: `${CONNECTOR_BRAND} Plugins`,
  description: 'Tools from external MCP integrations installed and enabled in MALACHI OVERDRIVE Settings, including Blender and other connected applications and services.',
