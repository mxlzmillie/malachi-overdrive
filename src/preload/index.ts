...
const api = {
  ...
  listProjectFiles: (id: string) => call<import('../main/project-files.js').ProjectFiles>('projects:files', { id }),
  previewProjectFile: (id: string, path: string) => call<{ text: string; truncated: boolean }>('projects:preview', { id, path }),
  ...
  bridgePairingCode: () => call<string>('bridge:pairingCode'),
