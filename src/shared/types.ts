...
export const CHAT_BROWSERS = ['chrome', 'edge', 'brave', 'opera-air'] as const;
 ...
 *   a manual download.
 * - `downloading` / `ready` — it is being fetched, or is fetched and will restart/install
 *   automatically once the laptop and app work are idle. An ordinary quit also applies it.
