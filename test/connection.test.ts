...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    publication: vi.fn((surface: string, observe: (name: string, version: string, instructions: string, tools: unknown[]) => void) => observe(`MALACHI OVERDRIVE ${surface}`, '1', 'instructions', [])),
