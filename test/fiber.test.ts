 ...
 */
const APP = 'MALACHI OVERDRIVE Core';
const DESKTOP_APP = 'MALACHI OVERDRIVE Desktop';
...
describe('the calls a turn says it made', () => {
  ...
  /**
   * A name is not a prefix game. `MALACHI OVERDRIVE Backup` shares every character of the
  ...
  it('refuses a connector whose name merely starts with this app’s brand', async () => {
    const messages = [
      request('req-fake', 'read', { app: 'MALACHI OVERDRIVE Backup' }),
      answer('res-fake', 'req-fake', 'read', 'MALACHI OVERDRIVE Backup'),
